# -*- coding: utf-8 -*-
"""
Created on Thu Aug  8 11:53:08 2024
...
output_dir = os.path.expanduser('~/NAS/projects/2024VisDev/FF_plots_1600_Synthetic_auto_POC_subfinal')
...
a = downsample_data(exc_data, 1, 500) # Adjust size to match the RNN training duration
